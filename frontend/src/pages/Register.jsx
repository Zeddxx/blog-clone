...
const Register = () => {
  ...
  return (
    ...
    <div className="flex flex-col justify-center items-center space-y-4 w-[80%] md:[25%]">
        ...
        <button onClick={handleRegister} className='w-full px-4 py-4 text-lg font-bold text-white bg-black rounded-lg hover:bg-gray-500 hover:text-black'>Login</button>
